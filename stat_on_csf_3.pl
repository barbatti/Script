...
# PROG    - program information (1 - Columbus; 2 - Turbomole TDDFT)
...
# 
# This progran was written by Mario Barbatti, 2009-2010.
#
...
#            FINISHING STEP        1, TIME     0.50 fs on SURFACE        4
   ...
   # Instructions to implement any other program besides Columbus and Turbomole (TDDFT):
