...
open(OUT,">ethylidene_count-v2.log");
...
$err_etd=$zci*sqrt($ftotal_etd*(1-$ftotal_etd)/$total);
$err_eth=$zci*sqrt($ftotal_eth*(1-$ftotal_eth)/$total);
$err_H  =$zci*sqrt($ftotal_H*(1-$ftotal_H)/$total);
$err_2H =$zci*sqrt($ftotal_2H*(1-$ftotal_2H)/$total);
$err_3H =$zci*sqrt($ftotal_3H*(1-$ftotal_3H)/$total);
$err_4H =$zci*sqrt($ftotal_4H*(1-$ftotal_4H)/$total);
$err_CH4 =$zci*sqrt($ftotal_CH4*(1-$ftotal_CH4)/$total);
